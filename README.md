...
---
**Q:** Могу ли я зарегистрировать два разных shopId на один бот. Что бы мне выдали 2 разных платежных токена, для двух разных shopId в одном боте?

**A:** Нет, один бот = один shopid (и в принципе одна интеграция с любой платёжной системой через Telegram Payments API).

---
**Q:** Работают ли платежи через веб-версии Telegram? (нативное решение)
